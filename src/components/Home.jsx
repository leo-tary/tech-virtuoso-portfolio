...
import userImg from "../assets/portfolio/man.png";
...
const Home = () => {
  return (
    ...
    >
      {/* <div className="flex flex-col items-center absolute top-1/4 md:flex-row  mx-auto"> */}
      <div className="flex flex-col items-center justify-around h-full mx-auto md:flex-row">
        ...
        <div className=" rounded-xl py-5 flex flex-col items-baseline gap-4 mt-20 px-5 mx-auto">
          ...
          {/* <button className="group flex items-center w-fit p-2 rounded-xl text-slate-300 bg-gradient-to-r from-cyan-500 to-blue-500">
            <span className="font-semibold">Portfolio</span>
            <span className="group-hover:rotate-90 duration-300">
              <MdOutlineKeyboardArrowRight size={20} />
            </span>
